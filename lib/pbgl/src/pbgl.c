...
int pbgl_init(int init_pbkit) {
	...
	p = push_command_parameter(p, NV097_SET_TRANSFORM_EXECUTION_MODE, PBGL_MASK(NV097_SET_TRANSFORM_EXECUTION_MODE_MODE, NV097_SET_TRANSFORM_EXECUTION_MODE_MODE_FIXED) | PBGL_MASK(NV097_SET_TRANSFORM_EXECUTION_MODE_RANGE_MODE, NV097_SET_TRANSFORM_EXECUTION_MODE_RANGE_MODE_PRIV));
	...
	p = push_command_parameter(p, NV097_SET_SHADER_OTHER_STAGE_INPUT, PBGL_MASK(NV097_SET_SHADER_OTHER_STAGE_INPUT_STAGE1, 0) | PBGL_MASK(NV097_SET_SHADER_OTHER_STAGE_INPUT_STAGE2, 0) | PBGL_MASK(NV097_SET_SHADER_OTHER_STAGE_INPUT_STAGE3, 0));
