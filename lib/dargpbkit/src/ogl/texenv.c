...
static inline GLuint *texenv_push_src_rgb(
	...
	const GLuint stage,
	const GLuint a,
	const GLboolean a_rgb,
	const GLuint a_map,
	const GLuint b,
	const GLboolean b_rgb,
	const GLuint b_map,
	const GLuint c,
	const GLboolean c_rgb,
	const GLuint c_map,
	const GLuint d,
	const GLboolean d_rgb,
	const GLuint d_map) {
	return pb_push1(p, NV097_SET_COMBINER_COLOR_ICW + stage * 4, PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_A_SOURCE, a) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_A_ALPHA, !a_rgb) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_A_MAP, a_map) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_B_SOURCE, b) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_B_ALPHA, !b_rgb) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_B_MAP, b_map) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_C_SOURCE, c) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_C_ALPHA, !c_rgb) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_C_MAP, c_map) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_D_SOURCE, d) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_D_ALPHA, !d_rgb) | PBGL_MASK(NV097_SET_COMBINER_COLOR_ICW_D_MAP, d_map));
}
...
static inline GLuint *texenv_push_src_a(
	...
	const GLboolean d_rgb,
	const GLuint d_map) {
	return pb_push1(p, NV097_SET_COMBINER_ALPHA_ICW + stage * 4, PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_A_SOURCE, a) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_A_ALPHA, !a_rgb) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_A_MAP, a_map) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_B_SOURCE, b) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_B_ALPHA, !b_rgb) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_B_MAP, b_map) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_C_SOURCE, c) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_C_ALPHA, !c_rgb) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_C_MAP, c_map) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_D_SOURCE, d) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_D_ALPHA, !d_rgb) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_ICW_D_MAP, d_map));
}
...
static inline GLuint *texenv_push_dst_rgb(GLuint *p, const GLuint stage, const GLboolean ab, const GLboolean cd, const GLboolean sum, const GLuint op) {
	return pb_push1(p, NV097_SET_COMBINER_COLOR_OCW + stage * 4, PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_AB_DST, ab ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_CD_DST, cd ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_SUM_DST, sum ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_MUX_ENABLE, 0) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_AB_DOT_ENABLE, 0) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_CD_DOT_ENABLE, 0) | PBGL_MASK(NV097_SET_COMBINER_COLOR_OCW_OP, op));
}
...
static inline GLuint *texenv_push_dst_a(GLuint *p, const GLuint stage, const GLboolean ab, const GLboolean cd, const GLboolean sum, const GLuint op) {
	return pb_push1(p, NV097_SET_COMBINER_ALPHA_OCW + stage * 4, PBGL_MASK(NV097_SET_COMBINER_ALPHA_OCW_AB_DST, ab ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_OCW_CD_DST, cd ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_OCW_SUM_DST, sum ? RC_SPARE0 : RC_DISCARD) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_OCW_MUX_ENABLE, 0) | PBGL_MASK(NV097_SET_COMBINER_ALPHA_OCW_OP, op));
}
...
GLuint *pbgl_texenv_push(GLuint *p) {
	...
	// push shader modes
	p = pb_push1(p, NV097_SET_SHADER_STAGE_PROGRAM, PBGL_MASK(NV097_SET_SHADER_STAGE_PROGRAM_STAGE0, shadermask[0]) | PBGL_MASK(NV097_SET_SHADER_STAGE_PROGRAM_STAGE1, shadermask[1]) | PBGL_MASK(NV097_SET_SHADER_STAGE_PROGRAM_STAGE2, shadermask[2]) | PBGL_MASK(NV097_SET_SHADER_STAGE_PROGRAM_STAGE3, shadermask[3]));

	// set up final combiner
	// this should be `out.rgb = spare0.rgb; out.a = spare0.a;`
	p = pb_push1(p, NV097_SET_COMBINER_CONTROL, PBGL_MASK(NV097_SET_COMBINER_CONTROL_FACTOR0, NV097_SET_COMBINER_CONTROL_FACTOR0_SAME_FACTOR_ALL) | PBGL_MASK(NV097_SET_COMBINER_CONTROL_FACTOR1, NV097_SET_COMBINER_CONTROL_FACTOR1_SAME_FACTOR_ALL) | PBGL_MASK(NV097_SET_COMBINER_CONTROL_ITERATION_COUNT, num_stages));
	p = pb_push1(p, NV097_SET_COMBINER_SPECULAR_FOG_CW0, PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_A_SOURCE, RC_ZERO) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_A_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_A_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_B_SOURCE, RC_ZERO) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_B_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_B_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_C_SOURCE, RC_ZERO) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_C_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_C_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_D_SOURCE, reg_out) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_D_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW0_D_INVERSE, 0));
	p = pb_push1(p, NV097_SET_COMBINER_SPECULAR_FOG_CW1, PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_E_SOURCE, RC_ZERO) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_E_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_E_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_F_SOURCE, RC_ZERO) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_F_ALPHA, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_F_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_G_SOURCE, reg_out) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_G_ALPHA, 1) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_G_INVERSE, 0) | PBGL_MASK(NV097_SET_COMBINER_SPECULAR_FOG_CW1_SPECULAR_CLAMP, 0));
